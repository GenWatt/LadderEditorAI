"""Loader that uses Selenium to load a page with wait time, then uses unstructured to load the html."""
...
class CustomSeleniumLoader(BaseLoader):
    """Load `HTML` pages with `Selenium` and parse with `Unstructured`.

    This loader waits for a specified amount of time for the page to fully render.
    ...
    Attributes:
        ...
        wait_time (int): Number of seconds to wait after page load.
    """
    ...
    def __init__(
        ...
        """Load a list of URLs using Selenium and unstructured with wait time."""
        try:
    ...
    def load(self) -> List[Document]:
        ...
        Waits for the specified wait time after page loads to allow JavaScript rendering.
        ...
        for url in self.urls:
            try:
                ...
                print(f"Waiting {self.wait_time} seconds for page to fully render...")
